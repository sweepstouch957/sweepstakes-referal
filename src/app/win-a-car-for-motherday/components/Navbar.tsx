...
import UserMenu from "@/app/win-a-weekly-tv/components/UserMenu";
...
export default function Navbar({ hideActions = false, hideMobileMenu = false }: NavbarProps) {
  ...
  const handleScrollToForm = () => {
    if (pathName === "/win-a-car-for-motherday") {
      const formElement = document.getElementById("form");
      if (formElement) {
        formElement.scrollIntoView({ behavior: "smooth" });
      }
    } else {
      router.push("/win-a-car-for-motherday?scrollTo=form");
    }
  };
