...
function StoreBanner({
  ...
  return (
    <Container maxWidth="sm" sx={{ mt: 0.2, mb: 0.15, px: 0 }}>
      <Box
        sx={{
          background: "linear-gradient(180deg, #db1459 0%, #b40e3b 100%)",
          borderRadius: 2.5,
          p: 0,
          color: "#fff",
          boxShadow: "0 8px 20px rgba(180, 14, 59, 0.18)",
          overflow: "hidden",
        }}
      >
        <Stack
...
function WinACarFormContainer() {
  ...
  const motherdaySweepstakeId = (
    process.env.NEXT_PUBLIC_SWEEPSTAKE_ID_MOTHERDAY_CAR ||
    ""
  ).toString();
  ...
  return (
    <Box
      sx={{
        ...
        background:
          "linear-gradient(180deg, #c8104f 0%, #db1459 12%, #ffffff 12%, #ffffff 100%)",
      }}
    >
