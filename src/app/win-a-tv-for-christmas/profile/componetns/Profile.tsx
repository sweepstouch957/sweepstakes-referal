            ...
            .map((coupon, idx) => (
              <Box
                ...
                sx={{
                  ...
                  boxShadow: isDark
                    ? "0 4px 32px 0 #c6282819, 0 1.5px 5px 0 #c6282840 inset"
                    : "0 4px 24px 0 #c6282808",
                  borderRadius: 4,
          ...
          <>
            <Box
              sx={{
                ...
                gap: 1,
                background: isDark
                  ? "linear-gradient(90deg,#c6282820 70%,#23192d 100%)"
                  : "linear-gradient(90deg,#c6282810 70%,#fff 100%)",
                borderRadius: 3,
          ...
          <>
            ...
            <Box
              sx={{
                ...
                alignItems: "center",
                gap: 1,
                background: isDark ? "#23192d" : "#ffebee",
                borderRadius: 2,
                py: 0.5,
                px: 2.7,
                mb: 2,
                border: `1.6px solid ${accent}`,
                boxShadow: isDark ? "0 0 14px #c6282821" : "0 0 8px #c6282812",
              }}
            >
              <Typography
                variant="h6"
