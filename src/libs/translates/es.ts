const es = {
  translation: {
    ...
    form: {
      ...
      smsConsentDisclaimer: "Al marcar esta casilla, aceptas recibir mensajes de texto promocionales recurrentes de Sweepstouch, incluyendo ofertas de supermercado, cupones, especiales semanales y actualizaciones promocionales. La frecuencia de los mensajes puede variar. El consentimiento no es una condición de compra. Responde STOP para darte de baja y HELP para obtener ayuda. Pueden aplicarse tarifas por mensajes y datos. Consulta nuestros Términos y Condiciones y Política de Privacidad. Los datos de suscripción móvil no se compartirán con terceros.",
