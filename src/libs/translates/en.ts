const en = {
  translation: {
    ...
    form: {
      ...
      smsConsentDisclaimer: "By checking this box, you agree to receive recurring promotional text messages from Sweepstouch, including grocery deals, coupons, weekly specials, and promotional updates. Message frequency may vary. Consent is not a condition of purchase. Reply STOP to opt out and HELP for help. Message and data rates may apply. View our Terms & Conditions and Privacy Policy. Mobile opt-in data will not be shared with third parties.",
